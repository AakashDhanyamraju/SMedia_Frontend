...
const Post = ({ likes, media, content, user, increaselikes, avatar, userId }) => {
    ...
    <div className="card mb-3 mt-3">
        ...
        <div className="d-flex align-items-center">
          <div className="rounded-circle object-fit-contain">
            ...
            <img
              ...
              src={avatar ? avatar : "https://st3.depositphotos.com/6672868/13701/v/450/depositphotos_137014128-stock-illustration-user-profile-icon.jpg"}
              alt="User Avatar"
      ...
      <div className="card-footer">
        <button onClick={handleLikes} className="btn btn-primary mr-2 m-1">
          <i className="bi bi-heart-fill mr-1"></i> Like
