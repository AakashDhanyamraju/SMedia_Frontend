...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:9000/friends/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                {profile.name
                  ? profile.name
                  : "User Choose not to display his name"}
                <br />
                {profile.bio}
                        ...
                        <div>
                          {friend.receiverId === currId ? (
                            <Button
                              ...
                              variant="primary"
                              onClick={() =>
                                handleCreateConversation(friend.senderId)
                              }
                            >
                              Message
                            </Button>
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleCreateConversation(friend.receiverId)
                              }
                            >
                              Message
                            </Button>
